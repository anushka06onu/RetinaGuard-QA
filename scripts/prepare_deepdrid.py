...
from src.retinaguard.data.adapters import parse_deepdrid_metadata, build_canonical_manifest


def main():
    parser = argparse.ArgumentParser(description="Prepare DeepDRiD canonical manifest.")
    parser.add_argument("--labels-csv", type=str, default="data/raw/deepdrid/regular_fundus_quality.csv")
