...
def main():
    ...
    deepdrid_splits = create_patient_grouped_splits(
        deepdrid_df, val_ratio=0.20, test_ratio=0.30, seed=2026
    )
    saved_deepdrid = save_split_manifests(
        deepdrid_splits, output_dir="data/splits", prefix="deepdrid"
    )
